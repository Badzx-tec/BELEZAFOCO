...
- Components: `Card`, `SectionTag`, `Badge`, `Button`, `Field`, `Input`, `Textarea`, `CheckboxField`, `EmptyState`, `SkeletonBlock`
- Description: base visual primitives reused across landing, booking, auth and dashboard.
