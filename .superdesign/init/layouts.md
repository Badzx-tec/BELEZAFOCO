...
- Description: primary authenticated shell with sidebar, sticky topbar, summary chips and mobile drawer.
...
- Description: route guard with centered session validation state and redirect to `/auth`.
